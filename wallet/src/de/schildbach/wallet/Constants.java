...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String EXTERNAL_WALLET_KEY_BACKUP = "digibyte-wallet-keys" + FILENAME_NETWORK_SUFFIX;

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "digibyte-wallet-backup" + FILENAME_NETWORK_SUFFIX;
	...
	public static final String VERSION_URL = "http://wallet.schildbach.de/version32";

	/** MIME type used for transmitting single transactions. */
	public static final String MIMETYPE_TRANSACTION = "application/x-dgbtx";

	/** MIME type used for transmitting wallet backups. */
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-digibyte-wallet-backup";

	/** Number of confirmations until a transaction is fully confirmed. */
	public static final int MAX_NUM_CONFIRMATIONS = 7;

	/** User-agent to use for network access. */
	public static final String USER_AGENT = "Digibyte Wallet";
	...
	public static final String REPORT_EMAIL = "dev@digibyte.co";
